...
public class SortableVirtualClassementView extends SortableTableView<RiderExtended> {
    ...
    public SortableVirtualClassementView(final Context context, final AttributeSet attributeSet, final int styleAttributes) {
        ...
        final SimpleTableHeaderAdapter simpleTableHeaderAdapter = new SimpleTableHeaderAdapter(context, R.string.virtrank_startnr, R.string.virtrank_img, R.string.virtrank_name, R.string.virtrank_team, R.string.virtrank_img, R.string.virtrank_country, R.string.virtrank_offical_time, R.string.virtrank_offical_deficit, R.string.virtrank_virt_deficit, R.string.virtrank_point_bonus, R.string.virtrank_point_mountain, R.string.virtrank_point_sprint, R.string.virtrank_price_money);
        ...
        final TableColumnWeightModel tableColumnWeightModel = new TableColumnWeightModel(13);
        ...
        tableColumnWeightModel.setColumnWeight(12, 3);
