...
@RealmModule(classes = {Rider.class, RaceGroup.class, RiderStageConnection.class, Judgement.class, Reward.class, JudgmentRiderConnection.class, Stage.class, Maillot.class, RiderRanking.class})
